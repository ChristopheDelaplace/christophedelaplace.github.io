...
Je suis actionnaire d'ams-OSRAM AG (SIX: AMS) depuis environ 2020, à titre personnel, via un compte-titres français (BNP Paribas, nominee Credit Agricole Titres/Broadridge). Le titre a fait un parcours de près de +150% depuis son point bas, porté principalement par un redressement de bilan aujourd'hui largement connu et intégré par le marché. Ce texte fixe où j'en suis dans ma réflexion, avant que le second moteur de la thèse — encore largement non valorisé — ne se confirme ou s'éteigne.

Au 11 septembre 2026, l'action cote CHF 18,25, en repli d'environ 24% depuis son pic de mai (CHF 23-24, après le relèvement de recommandation de JPMorgan). Capitalisation boursière d'environ CHF 1,83 milliard, pour environ 99,84 millions d'actions en circulation.
...
Mon hypothèse de travail privilégiée pour ce partenaire est Microsoft/MOSAIC (architecture "wide-and-slow", GaN visible, portée ~50m — cohérente avec l'héritage GaN monolithique d'ams/EVIYOS, et avec MediaTek comme partenaire transceiver de preuve de concept nécessitant des fournisseurs d'émetteurs microLED non nommés). Les réponses écrites de l'IR reçues le 17 juin 2026 confirment des spécifications techniques précises (≥3 Gbit/s par canal, <2 pJ/bit, liaisons jusqu'à 50 mètres) alignées sur cette architecture, et excluent formellement tout candidat "startup" (Avicena, OLIX) comme partenaire mystère — Avicena étant repositionné comme concurrent/client en design de transceivers plutôt que partenaire exclusif de fabrication.

Un point d'inflexion dans ma propre lecture (13 septembre 2026) : aucun des hyperscalers candidats ne possède de capacité de fabrication microLED en propre. Ams-OSRAM pourrait donc fonctionner comme fournisseur/fonderie horizontale pour l'ensemble de l'écosystème — une analogie TSMC ou Coherent-Lumentum — plutôt que d'être verrouillé sur un partenaire bilatéral exclusif. Cette lecture est appuyée par les réponses IR elles-mêmes, qui évoquent un travail "with multiple partners and customers across the datacom industry... independent of specific collaborations". Sous cette hypothèse, le partenaire nommé fin 2025/début 2026 serait mieux compris comme un client-ancre ayant coformé le cahier des charges initial, plutôt que le seul débouché commercial futur — ce qui déplace la question de valorisation de "qui est le partenaire" vers le TAM total multi-hyperscalers du marché "wide-and-slow".
...
<!-- Réservé aux mises à jour futures, chacune datée -->
